...
class MainMenu extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.image("player","../public/images/angrypose.png");
        this.load.image("enemy","../public/images/angryenemy.png");
        this.load.image("knight","../public/images/guard-alert.png");
        this.load.image('particle', '../public/images/particle.png');
        this.load.image('decoration','../public/images/decoration.png');
        
        this.load.audio('button-click','../public/Audios/button-click.wav');
        this.load.audio('theme', '../public/Audios/theme.mp3');
    }
